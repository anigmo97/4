...
typedef enum {
	...
	NUMLINES_L,
	PERIODE_L,
	PERIODO_ESPERA_CURACIONES_L, //AÑADIDO PARTE ENTREGA3
	...
	SUPPORT_COLOR_L, //AÑADIDO ENTREGA 3
	SUPPORT_NUM_CURATIONS_L, //AÑADIDO ENTREGA3
	TEXTURE_L,
	TEXTURE2D_L,
	TEXTURE3D_L,
	TIMECIRCLESHIP_L,
	...
	UMBRAL_PASA_A_ESTADO_DAÑADO_L,
	UMBRAL_DAÑO_PLAYER_CURAR_L,
	VERSION_L,
	X_L,			//Pos. X
	Y_L,			//Pos. Y
	Z_L,			//Pos. Z
