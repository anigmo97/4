...
void CSIGame::AssignSounds2Objects()
{
	...
	//Support sounds asignment
	Support->SetSoundsAmount(SUPPORT_NUM_SONIDOS);
	Support->SetSound(SoundsManager.GetSound(CGS_SUPPORT_SONIDO_MURIENDO), SUPPORT_SONIDO_MURIENDO);
	Support->SetSound(SoundsManager.GetSound(CGS_SUPPORT_SONIDO_ESCUDO_ROTO), SUPPORT_SONIDO_ESCUDO_ROTO);
	Support->SetSound(SoundsManager.GetSound(CGS_SUPPORT_SONIDO_DISPARO_A_ESCUDO), SUPPORT_SONIDO_DISPARO_A_ESCUDO);
	Support->SetSound(SoundsManager.GetSound(CGS_SUPPORT_SONIDO_REAPARECER), SUPPORT_SONIDO_REAPARECER);
	Support->SetSound(SoundsManager.GetSound(CGS_SUPPORT_SONIDO_CURAR_PLAYER), SUPPORT_SONIDO_CURAR_PLAYER);
}
